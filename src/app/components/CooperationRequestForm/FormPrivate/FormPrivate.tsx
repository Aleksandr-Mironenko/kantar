...
import { FileObj, PrivateIndividualFields } from "../../DTO/DTO";
...
export default function FormPrivate() {
  ...
  const { register, handleSubmit, control, formState: { errors, isValid, },   /*trigger, watch,*/ reset } = useForm<PrivateIndividualFields>({
