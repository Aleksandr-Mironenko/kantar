...
//   {
//     name: 'from_full_adress', type: 'PDFTextFie
// ld' },
//   { name: 'from_city', type: 'PDFTextField' },
//   {
//     name: 'from_country', type: 'PDFTextField'
//   },
//   { name: 'from_phone', type: 'PDFTextField' },
//   { name: 'where_phone', type: 'PDFTextField' }
//   ,
//   { name: 'where_name', type: 'PDFTextField' },
//   {
//     name: 'where_full_adress', type: 'PDFTextFi
// eld' },
//   { name: 'where_sity', type: 'PDFTextField' },
//   {
//     name: 'where_country', type: 'PDFTextField'
//   },
//   { name: 'from_code', type: 'PDFTextField' },
//   { name: 'where_code', type: 'PDFTextField' },
//   { name: 'Product', type: 'PDFTextField' },
//   { name: 'Payment', type: 'PDFTextField' },
//   { name: 'Freight', type: 'PDFTextField' },
//   {
//     name: 'array_services', type: 'PDFTextField
// ' },
//   { name: 'Ref', type: 'PDFTextField' },
//   { name: 'saved_price', type: 'PDFTextField' }
//   ,
//   {
//     name: 'volume_total_heft', type: 'PDFTextFi
// eld' },
//   { name: 'total_heft', type: 'PDFTextField' },
//   { name: 'sum_places', type: 'PDFTextField' },
//   { name: 'Content', type: 'PDFTextField' },
//   {
//     name: 'array_numbers_places', type: 'PDFTex
// tField' }
// ]\n