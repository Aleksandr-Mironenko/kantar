  ...
  return (
    <section className={styles.who}>
      <div className="container">
        ...
        <h3 className={styles.h3}>Kantar – надежная логистическая компания.</h3>
        <div className={styles.barier}></div>
        <p className={styles.p}>KANTAR- ведущая логистическая компания, специализирующаяся на международных перевозках. Гибкость в подходах помогают разрешать сложные логистические задачи и подбирать лучшие транспортные решения для каждого груза, помогая нашим клиентам успешно развивать свой бизнес. Мы выполняем весь комплекс работ: от подготовки маршрута перевозки до таможенного оформления.</p>
      </div>
    </section>
  )
}