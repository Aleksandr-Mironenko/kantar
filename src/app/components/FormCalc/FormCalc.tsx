...
export default function FormCalc() {
  ...
  const onSubmit = async (data: ValuesFromCalc) => {
    ...
    const response = await fetch("/api/personal-calculation", {
  ...
  return (
    <section className={styles.formcalc} >
      ...
      <h3 className={styles.formcalc__title}>Запрос на персональный рассчет</h3>
            ...
            <div className={styles.label__wrapper}  >
              <label className={errors.comment ? styles.label_error : styles.label}>
                ...
                <textarea {...register("comment")} rows={4}
                  placeholder="Укажите особенности товара, город забора и получения груза, предпочтения по формату перевозки"
